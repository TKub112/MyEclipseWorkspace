 ...
 */
@Getter
public class ServerSaveTask implements Comparable<ServerSaveTask>
    {
     ...
     */
    public ServerSaveTask(String userName, String fileName, Socket socket, String sendTo)
        {
     ...
     * @param socket   referencja na socket uzytkownika
     */
    public ServerSaveTask(String userName, String fileName, Socket socket)
        {
        this.userName = userName;
        this.fileName = fileName;
        this.socket = socket;
    ...
    @Override
    public int compareTo(ServerSaveTask o)//20  1 =-1 | 2 99 = 1
    {
